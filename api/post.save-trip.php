...
use Transport\{ Airline, Config, Email, EmailTemplates, Location, Template, Trip, User, Vehicle, VehicleReservation };
...
$trip->vehiclePUOptions = $input->getString('vehiclePUOptions') ?: null;
$trip->vehicleDOOptions = $input->getString('vehicleDOOptions') ?: null;
